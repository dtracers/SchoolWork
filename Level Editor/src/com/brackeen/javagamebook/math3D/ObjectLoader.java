...
import com.brackeen.javagamebook.util.FileLoader;
...
public class ObjectLoader {
    ...
    */
    ...
    //    System.out.println("with thier dumb path thingies "+file.getAbsolutePath());
    	System.out.println("im the file that your looking for "+filename);
        BufferedReader reader = f.datFile(filename);
    ...
    protected class ObjLineParser implements LineParser {
            ...
            NumberFormatException, NoSuchElementException
        {
            ...
            if (command.equals("v")) {
                ...
                String name = tokenizer.nextToken();
                parseFile(new File(path, name).toString());
            }
